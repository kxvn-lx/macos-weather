...
struct CurrentConditions: Codable {
    ...
    let windgust: Double?
    let windspeed, winddir, visibility: Double
    let uvindex: Int
...
struct Day: Codable {
    let datetime: String
    let tempmax, tempmin, temp, feelslikemax: Double
    let feelslikemin, feelslike, dew, humidity: Double
    let precip, precipprob, precipcover: Double
    let preciptype: [Preciptype]?
    let windgust, windspeed, winddir, visibility: Double
    let uvindex: Int
    let sunrise, sunset: String
    let moonphase: Double
    let conditions: Conditions
